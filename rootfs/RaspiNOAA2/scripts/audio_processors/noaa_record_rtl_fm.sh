...
log "Starting rtl_fm capture with Target: ${OUT_FILE} Gain: ${GAIN} Frequency: ${freq}M Offset: ${FREQ_OFFSET} Device: ${SDR_DEVICE_ID} Bias Tee: ${BIAS_TEE} Capture time: ${CAPTURE_TIME}" "INFO"

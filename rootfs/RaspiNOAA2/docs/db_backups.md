...
cat <(crontab -l) <(echo "5 0 * * * /raspiNOAA2/scripts/tools/db_backup.sh") | crontab -
```
...
```bash
cp /RaspiNOAA2/raspberry-noaa-v2/db_backups/panel.db.20210212.backup /RaspiNOAA2/raspberry-noaa-v2/db/panel.db
```
